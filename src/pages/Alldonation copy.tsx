...
import "./AllDonation/DonationSection.css";
import qrCode from "./AllDonation/qrcode.png"; // Replace with your QR code image path
...
import DonateModal from "./AllDonation/DonateModal";
...
const Alldonation: React.FC = () => {
  ...
  return (
    <section className="donation-section">
      ...
      <h1 className="donation-title"> Iskcon Juhu Donation </h1>
      ...
      <div className="info-cards">
        ...
        <div className="info-card-image">
          <img
            src="https://www.google.com/url?sa=i&url=https%3A%2F%2Fpixabay.com%2Fillustrations%2Fkrishna-god-hindu-india-vrindavan-8784102%2F&psig=AOvVaw2svA9MH7n7zW73vCI00l_4&ust=1737033324578000&source=images&cd=vfe&opi=89978449&ved=0CBQQjRxqFwoTCOCAl8Tn94oDFQAAAAAdAAAAABAZ" // Replace with the actual image path
      ...
      {/* Makarsankranti */}
      <h2 className="meal-donation-title">Donate for Makarsankranti Anna Daan</h2>
