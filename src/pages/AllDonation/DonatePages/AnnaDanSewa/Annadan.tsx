...
import AnnaDaan from "../DonationImages/image-8664a663930201e.jpg"
import "./Annadan.css"
...
const Alldonation: React.FC = () => {
  ...
  return (
    <section className="donation-section-anna">
      ...
      <h1 className="donation-title-anna"> Iskcon Juhu Donation </h1>
      <div className="title-underline-anna"></div>

      {/* Information Cards */}
      <div className="info-card-annas">
        <div className="info-card-anna">
          <h2 className="info-card-anna-title">Anna Daan Seva</h2>
          ...
          <ul className="info-card-anna-list">
      ...
      {/* Makarsankranti */}
      <h2 className="meal-donation-title-anna">Donate for Makarsankranti Anna Daan</h2>
