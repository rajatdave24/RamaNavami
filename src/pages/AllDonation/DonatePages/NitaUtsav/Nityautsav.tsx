...
import NiyaUtsav from "../DonationImages/page-category-_106788ec9670de0.jpg"
    ...
    <section className="donation-section-anna">
      ...
      <div className="info-card-annas">
        <div className="info-card-anna">
          <h2 className="info-card-anna-title">Nitya Utsav Seva</h2>
        ...
        <div className="info-card-anna-image">
          <img
            src={NiyaUtsav} // Replace with the actual image path
      ...
      {/* Makarsankranti */}
      <h2 className="meal-donation-title-anna">Winter Special Seva (31 Dec 2024 to 31 Jan 2025)</h2>
      <div className="meal-options-anna">
        {[
          { label: "New Year Special Naivaidyam Seva", price: "1555" },
          { label: "Naivaidyam Seva, Gau Chara Seva", price: "2100" },
          { label: "Naivaidyam Seva, Offer Woolen Cap", price: "2555" },
          { label: "Naivaidyam Seva, New Year Arti Seva", price: "2800" },
          { label: "Naivaidyam Seva, Till and Jaggery Sweet", price: "3100" },
          { label: "Naivaidyam Seva, Annadaan Seva Contribution", price: "3500" },
          { label: "Naivaidyam Seva, Offer Woolen Muffler", price: "3555" },
          { label: "Naivaidyam Seva, Offer Woolen Cap, Offer Woolen Muffler", price: "5555" },
          { label: "Naivaidyam Seva, Offer 1 Woolen Shawl", price: "9555" },
          { label: "Naivaidyam Seva, Offer 2 Woolen Shawl", price: "16555" },
        ].map((meal, index) => (
