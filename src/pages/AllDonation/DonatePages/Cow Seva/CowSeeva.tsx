...
import AnnaDaan from "../DonationImages/image-1664a6639328072.jpg"

import "./CowDaanServices.css"
    ...
    <section className="donation-section-anna">
      ...
      <div className="info-card-annas">
        <div className="info-card-anna">
          <h2 className="info-card-anna-title">Cow Service</h2>
          ...
          By maintaining and serving cows with love and care, we not only catch the attention of Lord Krishna but also please Him.
          Gauseva bestows immense spiritual benefits.
          Additionally, the presence of cows in our surroundings is believed to 
          remove negative energies and bring positive energy. 
          Cows are glorified as Mothers of the universe in vedas.
          </p>
      ...
      {/* Makarsankranti */}
      <h2 className="meal-donation-title-anna">Cow Services</h2>
      <div className="meal-options-anna">
        {[
          { label: "Feed 10 Cows", price: "2600" },
          { label: "Feed 100 Cows", price: "5000" },
          { label: "Feed 200 Cows", price: "10000" },
          { label: "Feed 300 Cows", price: "15000" },
          { label: "Feed 500 Cows", price: "25000" },
          { label: "Feed 1,000 Cows", price: "50000" },
          { label: "Feed 2,000 Cows", price: "100000" },
          { label: "Feed 3,000 Cows", price: "200000" },
        ].map((meal, index) => (
